...
public class InfoAdicionaisDao {

    Session sessao;
    Transaction transacao;
    Criteria criterio;

    public void salvar(InfoAdicionais o) throws Exception {
    ...
    public void alterar(InfoAdicionais o) throws Exception {
        sessao = HibernateUtil.getInstance();
        transacao = sessao.beginTransaction();
        sessao.update(o);
        transacao.commit();
    ...
    public void excluir(InfoAdicionais o) throws Exception {
        sessao = HibernateUtil.getInstance();
        transacao = sessao.beginTransaction();
        sessao.delete(o);
        transacao.commit();
    ...
    public List listarTodos() throws Exception {
        sessao = HibernateUtil.getInstance();
        return sessao.createCriteria(InfoAdicionais.class).list();
    }
