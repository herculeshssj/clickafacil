            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="#">Lojas</a></h2>
                            ...
                            <div class="post">
                                ...
                                <table width="100%" border="1">
                                    <tr>
                                        <th width="33%" scope="col">Internauta</th>
                                        <th width="35%" scope="col">E-Mail</th>
                                        <th width="25%" scope="col">Produto Comentado</th>
                                        <th width="25%" scope="col">Data</th>
                                        <th width="25%" scope="col">Classificação</th>
                                        <th width="7%" scope="col">Visualizar</th>
                                        <th width="7%" scope="col">Excluir</th>
                                    </tr>
                                    <%
                                    ...
                                    %>
                                    <tr>
                                        <td><%=c.getIdInternauta().getNome()%></td>
                                        <td><%=c.getIdInternauta().getEmail()%> </td>
                                        <td><%=c.getIdLoja().getNomeFantasia()%></td>
                                        <td align="center"><%=c.getDataInclusao()%></td>
                                        <td align="center"><%=c.getClassificacao()%></td>
                                        <td align="center"><a onclick="MM_openBrWindow('ComentarioServlet?acao=visualizar&id=<%=c.getIdComentario()%>','','toolbar=no,location=no,status=no,menubar=no,directories=no,scrollbars=no,resizable=no,width=320,height=240')" href="#"><img src="images/visualizar.gif" alt="Editar" border="0"/></a></td>
                                        <td align="center"><a onclick="return confirmar()" href="ComentarioServlet?acao=excluir&id=<%=c.getIdComentario()%>"><img src="images/excluir.gif" alt="Excluir" border="0"/></a></td>
                                    </tr>
                                    <%
                                                }
                                    %>
                                ...
                                <br/><br/>
                                <center><a href="menuLojas.jsp"><< Voltar</a></center>
