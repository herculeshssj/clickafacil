            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="#">Gerenciar Produtos</a></h2>
                            ...
                            <div class="post">
                                ...
                                <p align="left"><b><a href="ProdutoServlet?acao=cadastrar">Novo Produto</a></b></p>
                                <br/>
                                <table width="100%" border="1">
                                    <tr>
                                        <th width="43%" scope="col">Produto</th>
                                        <th width="25%" scope="col">Categoria</th>
                                        <th width="25%" scope="col">Fabricante</th>
                                        <th width="25%" scope="col">Modelo</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=p.getIdCategoria().getNomeCategoria()%> </td>
                                        <td><%=p.getFabricante()%></td>
                                        <td align="center"><%=p.getModelo()%></td>
                                        <td align="center"><a href="ProdutoServlet?acao=editar&id=<%=p.getIdProduto()%>"><img src="images/alterar.gif" alt="Editar" border="0"/></a></td>
                                        <td align="center"><a onclick="return confirmar()" href="ProdutoServlet?acao=excluir&id=<%=p.getIdProduto()%>"><img src="images/excluir.gif" alt="Excluir" border="0"/></a></td>
                                    </tr>
                                    <%
                                                }
                                    %>
