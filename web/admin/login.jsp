...
<%
            ...
            if (request.getParameter("acao") != null && request.getParameter("acao").equals("sair")) {
                session.invalidate();
            } else {
                    ...
                    <div id="page-bgbtm">
                        <div id="sidebar">
                            <ul>
                                ...
                                <li>
                                    <!-- Área de mensagens   -->
                                    <font color="#FF0000"><center><strong>
                                            <%
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="login.jsp">Login</a></h2>
                            ...
                            <div class="post">
                                ...
                                <!-- Início do Conteúdo -->
                                <center>
                                    <form name="frmLogin" method="post" action="processaLogin.jsp">



                                        <strong>Login:</strong>
                                        <input type="text" id="txtLogin" name="txtLogin" maxlength="50" size="30"
                                               /><br/><br/>

                                        <strong>Senha:</strong>
                                        <input type="password" id="txtSenha" name="txtSenha" maxlength="50" size="30"
                                               /><br/><br/>
