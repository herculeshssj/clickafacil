        ...
        <div id="wrapper">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="menuConfig.jsp">Configurações</a></li>
            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="#">Configurações</a></h2>
                            ...
                            <div class="post">
                                ...
                                <!-- Início do Conteúdo -->
                                <h3><img src="images/icone.jpg" height="32" width="32" border="0"/><a href="mudarSenha.jsp">Mudar senha</a></h3><br/>
