            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="#">Gerenciar lojas</a></h2>
                            ...
                            <div class="post">
                                ...
                                <table width="100%" border="1">
                                    <tr>
                                        <th width="42%" scope="col">Loja</th>
                                        <th width="19%" scope="col">CNPJ</th>
                                        <th width="24%" scope="col">Site</th>
                                        <th width="33%" scope="col">Responsável</th>
                                        <th width="7%" scope="col">Editar</th>
                                    ...
                                    %>
                                    <tr>
                                        <td><%=lj.getNomeFantasia()%></td>
                                        <td align="center"><%=lj.getCnpj()%> </td>
                                        <td><a href="<%=lj.getSite()%>" target="_blank"><%=lj.getSite()%></a></td>
                                        <td align="center"><%=lj.getResponsavel()%></td>
                                        <td align="center"><a href="LojaServlet?acao=editar&id=<%=lj.getIdLoja()%>"><img src="images/alterar.gif" alt="Editar" border="0"/></a></td>
                                        <td align="center"><a onclick="return confirmar()" href="LojaServlet?acao=excluir&id=<%=lj.getIdLoja()%>"><img src="images/excluir.gif" alt="Excluir" border="0"/></a></td>
                                    </tr>
                                    <%
                                                }
                                    %>
