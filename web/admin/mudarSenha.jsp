        ...
        <div id="wrapper">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="menuConfig.jsf">Configurações</a></li>
            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="#">Mudar senha</a></h2>
                            ...
                            <div class="post">
                                ...
                                <!-- Início do Conteúdo -->
                                <center>
                                    <form name="frmMudarSenha" method="post" action="altSenha.jsp">



                                        <strong>Informe a senha atual:</strong>
                                        <input type="password" id="txtSenhaAtual" name="txtSenhaAtual" maxlength="50" size="30"
                                               /><br/><br/>

                                        <strong>Informe a nova senha:</strong>
                                        <input type="password" id="txtNovaSenha" name="txtNovaSenha" maxlength="50" size="30"
                                               /><br/><br/>

                                        <strong>Confirme a nova senha:</strong>
                                        <input type="password" id="txtConfirmaSenha" name="txtConfirmaSenha" maxlength="50" size="30"
                                               /><br/><br/>

                                        <input type="hidden" id="txtIdLogin" name="txtIdLogin" value="<%=l.getIdLogin()%>"/>

                                        <input type="submit" name="btnMudar"
                                               value="Mudar senha" />
                                    </form>
                                    <br/><br/>
                                    <a href="menuConfig.jsp"><< Voltar</a>
