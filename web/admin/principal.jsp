        ...
        <div id="wrapper">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li class="current_page_item"><a href="login.jsp?acao=sair">Sair</a></li>
                </ul>
            </div>
            <!-- end #menu -->
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="#">Administração do Site</a></h2>
                            ...
                            <div class="post">
                                ...
                                <!-- Início do Conteúdo -->
                                Seja bem-vindo a área de administração do site.<br/><br/>
                                Aqui você pode configurar seus produtos anunciados no site e alterar seus dados pessoais.<br/><br/>
                                Fique a vontade e descubra os incríveis recursos oferecidos pelo sistema.
