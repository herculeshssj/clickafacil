...
<%
            ...
            String submit = "processaCategoria.jsp?acao=salvar";

            Categoria c = (Categoria) request.getAttribute("categ");
            ...
            if (c == null) {
                ...
                submit = "processaCategoria.jsp?acao=alterar";
            }
            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="#">Cadastrar Subcategoria</a></h2>
                            ...
                            <div class="post">
                                ...
                                <!-- Início do Conteúdo -->
                                <center>
                                    <form name="frmCadCategoria" method="post" action="<%=submit%>">

                                        <table border="0">
                                            <tr>
                                                <td><strong>Categoria:</strong></td>
                                                <td><input type="text" id="txtNomeCategoria" name="txtNomeCategoria" maxlength="50" value="<%=c.getNomeCategoria()%>"
                                                           class="contact_input" /></td>
                                            </tr>
                                            <tr>
                                                <td> <strong>Descrição:</strong></td>
                                                <td><textarea class="contact_textarea" id="txtDescricao" name="txtDescricao"><%=c.getDescricao()%></textarea></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td><input type="hidden" name="txtIdCategoria" id="txtIdCategoria" value="<%=c.getIdCategoria()%>"/></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td><input type="submit" name="btnSalvar"
                                                           value="Salvar" /></td>
                                            </tr>
                                        </table>
                                    ...
                                    <br/>
                                    <p><a href="listaCategoria.jsp"><< Voltar</a></p>
                                </center>
                                <!-- Fim do conteúdo -->
