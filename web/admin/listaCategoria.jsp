            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        ...
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="#">Gerenciar subcategorias</a></h2>
                            ...
                            <div class="post">
                                ...
                                <!-- Início do Conteúdo -->
                                <p align="left"><b><a href="processaCategoria.jsp?acao=cadastrar">Nova Categoria</a></b></p>

                                <br/>
                                <table width="100%"  border="1">
                                    <tr>
                                        <th width="20%" scope="col"><div align="center">Categoria</div></th>
                                        <th width="66%" scope="col"><div align="center">Descrição</div></th>

                                        <th width="7%" scope="col"><div align="center">Editar</div></th>
                                        <th width="7%" scope="col"><div align="center">Excluir</div></th>
                                    </tr>
                                    <%
                                    ...
                                    %>
                                    <tr>
                                        <td align="center"><%=c.getNomeCategoria()%></td>
                                        <td><%=c.getDescricao()%></td>

                                        <td align="center"><a href="processaCategoria.jsp?acao=editar&id=<%=c.getIdCategoria()%>"><img src="images/alterar.gif" alt="Editar" border="0"/></a></td>
                                        <td align="center"><a onclick="return confirmar()" href="processaCategoria.jsp?acao=excluir&id=<%=c.getIdCategoria()%>" ><img src="images/excluir.gif" alt="Excluir" border="0"/></a></td>
                                    </tr>
                                    <%
                                                }
                                    %>
