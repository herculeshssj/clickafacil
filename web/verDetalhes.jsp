            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="login.jsp">Descrição</a></h2>
                            ...
                            <div class="post">
                                ...
                                <strong>Produto: &nbsp;</strong><% out.print(p.getNomeProduto());%><br/><br/>

                                <strong>Fabricante: &nbsp;</strong><% out.print(p.getFabricante());%><br/><br/>

                                <strong>Modelo: &nbsp;</strong><% out.print(p.getModelo());%><br/><br/>
