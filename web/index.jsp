            ...
            <div id="page">
                <div id="page-bgtop">
                    <div id="page-bgbtm">
                        <div id="content">
                            <div class="post">
                                <h2 class="title"><a href="index.jsp">Início</a></h2>
                            ...
                            <div class="post">
                                ...
                                <table border="0" width="100%" cellspacing="10">
                                    ...
                                    <%
                                                out.print("<tr>");
                                                for (int i = 1; i <= listaGrupo.size(); i++) {

                                                    if (i % 3 == 0) {
                                                        out.print("<td align=\"center\"><a href=\"listaCategoria.jsp?grp=" + listaGrupo.get(i - 1).getIdGrupo() + "\">" + listaGrupo.get(i - 1).getNomeGrupo() + "</a></td>");
                                                        out.print("</tr>");
                                                        out.print("<tr>");
                                                    } else {
                                                        out.print("<td align=\"center\"><a href=\"listaCategoria.jsp?grp=" + listaGrupo.get(i - 1).getIdGrupo() + "\">" + listaGrupo.get(i - 1).getNomeGrupo() + "</a></td>");
                             	 ...
                             	 out.print("Não existem categorias cadastradas.");  
                                }
                                    %>
